...
<body style="background-color: #f4e3cb">
    <div class="container">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active" class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="../programe/day1.php">Day 1</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <table border="5">
                    <caption><h1>Day 1: Monday 31/10/2016</h1></caption>
                    <tr>
                        <th>TIME</th>
                        <th>THEME</th>
                    </tr>
                    ...
                    <tr>
                        <td>9:00-10:30</td>
                        <td>Keynotes speakers: Prof. Dr. Antonia Moropoulou Prof. Dr. Dieter Fellner</td>
                    </tr>
                    <tr>
                        <td>10:30-11:00</td>
                        <td>Coffee Break</td>
                    ...
                    <tr>
                        <td>11:00-13:00</td>
                        <td>FORUM PANEL Erasing History and the Role of Documentation in Tracking and Proving Ownership of Looted Cultural Propert Chairwoman: Eleanor Fink</td>
                    </tr>
                    <tr>
                        <td>13:00-14:00</td>
                        <td>LUNCH</td>
                    ...
                    <tr>
                        <td>14:00-15:30</td>
                        <td>FORUM PANEL Re-Thinking Management and Valorization of Middle East Cultural Heritage in the Post-War period: Where Disasters Turns to Opportunity, Development and Growth Chairman: Georgios G. Giannoulis</td>
                    </tr>
                    <tr>
                        <td>15:30-16:00</td>
                        <td>coffee break</td>
                    ...
                    <tr>
                        <td>16:00-17:00</td>
                        <td>EU H2020 INCEPTION PROJECT PANEL on 3D Semantics in CH Chairman: Prof. Dr. Roberto Di Giulio</td>
                    </tr>
                    <tr>
                           <td>17:00-18:30</td>
                        <td>EU PROJECT E-SPACE PANEL Europeana Sounds, EU ScreenXL,Europeana Fashion, Europeana Food and Drink, Photoconsortium, Energic-Od,Disruptive Media Learning Lab, Preforma Chairwoman: Prof. Dr. Sarah Whatley</td>
                    </tr>
                    <tr>
                        <td>19:00</td>
                        <td>FREE</td>
