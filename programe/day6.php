...
<body style="background-color: #f4e3cb">
    <div class="container">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active" class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="../programe/day6.php">Day 6</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
        ...
        <div class="row">
            <div class="col-md-12">
                <table border="5">
                    <caption><h1>Day 6: Saturday 5/11/2016</h1></caption>
                    <tr>
                        <th>TIME</th>
                        <th>THEME</th>
                    </tr>
                    ...
                    <tr>
                        <td>9:00-10:30</td>
                        <td>Keynote speaker:Prof. Dr. Gunnar Liestøl Beyond Pokémon GO. Storytelling,Mobile Augmented Reality and Cultural Heritage*IX. FULL / PROJECT / SHORT Papers Non Destructive Techniques and Digital Applications for Materials' Preservation and Conservation in Cultural Heritage"</td>
                    </tr>
                    <tr>
                        <td>10:30-11:00</td>
                        <td>Coffee Break</td>
