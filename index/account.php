...
<body style="background-color: #f4e3cb">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h1>Personal Account</h1><br>
                <fieldset>
                    <form action="../php/update.php" method="post">
                        <label for="username">User name:</label>
                        <input type="text" name="username" value="<?php echo $_SESSION['username']; ?>" readonly="readonly"><br>
                        <label for="firstname">First name:</label>
                        <input type="text" name="firstname" placeholder="Change First Name"><br>
                        <label for="lastname">Last name:</label>
                        <input type="text" name="lastname" placeholder="Change Last Name"><br>
                        <label for="email">Email:</label>
                        <input type="email" name="email" placeholder="Change email"><br>
                        <label for="">Country:</label>
                        <input type="text" name="country" placeholder="Change Country"><br>
