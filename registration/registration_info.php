            ...
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active" class="dropdown">
                        ...
                        <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li class="active"><a href="../registration/registration_info.php">Registration info</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <table border="2">
                    <tbody>
                        <tr>
                            <th class="border1">Registration type</th>
                            <th class="border1">
                                Early Bird Registration<br>
                                <span style="font-size: 8pt;">till 10 of December</span>
                            </th>
                            <th class="border1">
                                Standard Registration<br>
                                <span style="font-size: 8pt;">from 11th of December</span>
                            </th>
                        </tr>
                        <tr>
                            <td class="border1">Students</td>
                            <td class="border1">360€</td>
                            <td class="border1">450€</td>
                        </tr>
                        <tr>
                            <td class="border1">Non Students</td>
                            <td class="border1">440€</td>
                            <td class="border1">500€</td>
                        </tr>
                        <tr>
                            <td class="border1">Workshops(each)</td>
                            <td class="border1">30€</td>
                            <td class="border1">50€</td>
                        </tr>
                    </tbody>
                </table>
            </div>
